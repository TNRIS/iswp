    ...
    <div class="row panel-row">
        <div class="twelve columns">
            ...
            <div class="recommended-projects-container">
                ...
                <p class="note">Only strategy names that have strategy supplies assigned to a Water User Group are linked to a water management strategy page.</p>
            </div>
        </div>
    </div>
</div>
